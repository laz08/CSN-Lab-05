...
In this part of the assignment we are asked to verify if the distribution that better fits the scaling of selected vertices is a power-law distribution with gamma $\gamma=\frac{1}{2}$. In order to verify it we perform a model selection task as suggested in the statement. The results found are the following:
...
- Scaling of vertex 100, as for vertex 10, follows a p-law distribution but with a more free exponent.
